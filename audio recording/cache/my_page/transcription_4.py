    ...
    with tabs[2]:  # Onglet Mots-clés
        ...
        with col1:
            ...
            gpt_model = st.selectbox(
                ...
                index=0,
                key="keywords_model",
                help="GPT-3.5 est plus rapide, GPT-4o est plus précis mais plus coûteux"
            )
        ...
        with col2:
            ...
            # Information sur le coût
            price_per_1k = "$0.001" if gpt_model == "gpt-3.5-turbo" else "$0.01"
            st.caption(f"Coût estimé: $0.01-0.03")
